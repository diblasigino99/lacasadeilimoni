...
// ─── Palette ──────────────────────────────────────────────────────────────
const CAPRI  = "#A8C4D4"; // faded Capri sky blue
const LEMON  = "#F4D03F"; // dusty lemon yellow

// ─── Lemon SVG Watermark ───────────────────────────────────────────────────
const LemonWatermark = () => (
  <svg viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    {/* blue atmospheric wash behind the lemon */}
    ...
    {/* radial veins — alternating blue / lemon */}
    {[30, 60, 120, 150].map((deg, i) => {
      ...
      const color = i % 2 === 0 ? CAPRI : LEMON;
      return <line key={i} x1={x1} y1={y1} x2={x2} y2={y2} stroke={color} strokeOpacity="0.1" strokeWidth="0.5" />;
    })}
    {/* stem */}
  ...
  return (
    ...
    >
      <div className="max-w-screen-xl mx-auto px-8 md:px-16 py-8 flex items-center justify-between">
        <span
          className="font-['Cormorant_Garamond'] text-[11px] tracking-[0.35em] text-[#1A1A1A]/55 uppercase"
        ...
        <div className="absolute left-1/2 -translate-x-1/2">
          <span
            className="font-['Cormorant_Garamond'] italic text-[#1A1A1A] text-lg tracking-wide"
          >
            La Casa dei Limoni
          </span>
        </div>
        ...
        <span
          className="font-['Montserrat'] text-[9px] tracking-[0.4em] text-[#1A1A1A]/55 uppercase hidden md:block"
...
const Hero = () => {
  ...
  return (
    <section ref={ref} className="relative h-screen flex items-center justify-center overflow-hidden bg-[#F9F9F7]">
      {/* Capri sky gradient — top wash */}
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background: `linear-gradient(to bottom, ${CAPRI}18 0%, transparent 55%)`,
        }}
      />
      {/* Capri ambient orb — upper right */}
      <div
        className="absolute -top-20 right-[10%] w-[420px] h-[320px] rounded-full blur-3xl pointer-events-none"
        style={{ background: `${CAPRI}1A` }}
      />
      {/* background lemon art */}
      ...
      >
        ...
        >
          <motion.div
            ...
            className="w-px h-10 bg-gradient-to-b from-[#1A1A1A]/30 to-transparent"
          />
        </motion.div>
      </motion.div>
      ...
      >
        <p className="font-['Montserrat'] text-[8px] tracking-[0.35em] text-[#1A1A1A]/55 uppercase">
          Amalfi · New York
        </p>
      </motion.div>
...
const Manifesto = () => {
  ...
  return (
    <section ref={ref} className="relative py-40 md:py-56 px-8 overflow-hidden"
      style={{ background: `linear-gradient(to bottom, #F9F9F7, ${CAPRI}0D 40%, #F9F9F7)` }}
    >
      {/* decorative Y-axis line — blue */}
      <div className="absolute left-1/2 top-0 bottom-0 w-px"
        style={{ background: `linear-gradient(to bottom, transparent, ${CAPRI}30, transparent)` }}
      />
      ...
      >
        ...
        <p
          className="font-['Montserrat'] text-[9px] tracking-[0.45em] text-[#1A1A1A]/50 uppercase mb-12"
        >
          The Manifesto
        </p>

        <h2
          className="font-['Cormorant_Garamond'] italic text-[#1A1A1A] leading-[1.2] mb-12"
          style={{ fontSize: "clamp(2.4rem, 5.5vw, 4.5rem)" }}
        >
          The American Amalfi.
        </h2>
        <h2
          className="font-['Cormorant_Garamond'] text-[#1A1A1A]/75 leading-[1.2]"
        ...
        <div className="mt-16 max-w-lg mx-auto space-y-6">
          <p className="font-['Montserrat'] text-[11px] leading-[2.4] tracking-[0.08em] text-[#1A1A1A]/75">
        ...
        <motion.div
          ...
          className="w-8 h-px mx-auto mt-16 origin-center"
...
// ─── Art Print Placeholder ────────────────────────────────────────────────
const ArtPrint = () => (
  <section className="relative py-10 md:py-16 px-8 bg-[#F9F9F7]">
    <div className="max-w-screen-lg mx-auto">
      <motion.div
        ...
        transition={{ duration: 1.4, ease: [0.16, 1, 0.3, 1] }}
        className="relative aspect-[4/3] md:aspect-[16/7] overflow-hidden"
        style={{ background: `linear-gradient(135deg, #F0EDE4 0%, ${CAPRI}18 60%, #EAE8E0 100%)` }}
      >
        {/* placeholder art frame — blue */}
        <div className="absolute inset-8 border" style={{ borderColor: `${CAPRI}40` }} />
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center">
            <div className="w-40 h-40 mx-auto mb-8 opacity-20">
              <LemonWatermark />
            </div>
            <p className="font-['Montserrat'] text-[8px] tracking-[0.45em] text-[#1A1A1A]/55 uppercase">
              Watercolor Art Print · To Follow
            </p>
          </div>
        </div>
        {/* soft vignette */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#F9F9F7]/20 via-transparent to-[#F9F9F7]/30 pointer-events-none" />
      </motion.div>
      ...
      <motion.div
        ...
        className="mt-6 flex justify-between items-center px-1"
      >
        <span className="font-['Montserrat'] text-[8px] tracking-[0.35em] text-[#1A1A1A]/55 uppercase">
          Fig. I — Limoni in Sorrento
        </span>
        <span className="font-['Cormorant_Garamond'] italic text-[#1A1A1A]/55 text-sm">
          Original watercolour, 2024
        </span>
      </motion.div>
    </div>
  </section>
...
const Waitlist = () => {
  ...
  return (
    <section className="relative py-48 md:py-64 px-8 bg-[#F9F9F7] overflow-hidden">
      {/* dual ambient orbs — lemon left, Capri right */}
        ...
        <AnimatePresence mode="wait">
          {!submitted ? (
            ...
            >
              <div
                className={`relative border-b transition-all duration-500 ${
                  focused ? "border-[#1A1A1A]/40" : "border-[#1A1A1A]/12"
                }`}
              >
                <input
                  type="email"
                  ...
                  className="w-full bg-transparent font-['Montserrat'] text-[11px] tracking-[0.15em] text-[#1A1A1A] placeholder-[#1A1A1A]/20 py-4 pr-12 outline-none"
                />
                <button
                  onClick={handleSubmit}
                  className="absolute right-0 top-1/2 -translate-y-1/2 p-1 group"
                  aria-label="Submit"
                >
                  <ArrowRight
                    size={14}
                    className="text-[#1A1A1A]/75 group-hover:text-[#1A1A1A]/70 transition-colors duration-300"
                    strokeWidth={1.5}
                  />
                </button>
              </div>

              {/* animated underline fill — Capri blue */}
              <motion.div
              ...
              <p className="mt-6 font-['Montserrat'] text-[8px] tracking-[0.3em] text-[#1A1A1A]/50 uppercase">
            ...
            <motion.div
              ...
              className="py-8"
            >
              <p className="font-['Cormorant_Garamond'] italic text-[#1A1A1A]/75 text-xl mb-3">
                You are inside.
              </p>
              <p className="font-['Montserrat'] text-[9px] tracking-[0.3em] text-[#1A1A1A]/55 uppercase">
...
const Footer = () => (
  <footer className="py-16 px-8 md:px-16 bg-[#F9F9F7]" style={{ borderTop: `1px solid ${CAPRI}30` }}>
    <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
      <span className="font-['Cormorant_Garamond'] italic text-[#1A1A1A]/75 text-sm">
        La Casa dei Limoni
      </span>
      <span className="font-['Montserrat'] text-[8px] tracking-[0.35em] text-[#1A1A1A]/50 uppercase">
